...
(138, 'billnote', 'index', 'billNotes', 'bill notes', NULL, NULL),
(139, 'billnote', 'edit', 'edit billNotes', 'bill notes', NULL, NULL),
(140, 'billnote', 'update', 'update billNotes', 'bill notes', NULL, NULL),
(141, 'repraircard', 'receiptInvoicePayment', 'receipt Invoice Payment', 'print receipt Invoice Payment', NULL, NULL),
(142, 'repraircard', 'addServiceItem', 'add service item', 'add service item', NULL, NULL),
(143, 'repraircard', 'storeServiceItem', 'store service item', 'store service item', NULL, NULL),
(144, 'cardtaxes', 'update', 'update Card Taxes', 'Card Taxes', NULL, NULL),
(145, 'cardtaxes', 'edit', 'edit Card Taxes', 'Card Taxes', NULL, NULL),
(146, 'cardtaxes', 'index', 'Card Taxes', 'Card Taxes', NULL, NULL);
...
--
ALTER TABLE `roles`
  MODIFY `role_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;
COMMIT;
