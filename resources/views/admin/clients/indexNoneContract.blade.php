        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-header">
                        <a href="{{route('noneContractClient.createNoneContractClient')}}" style="margin-top: 10px;" class="btn btn-success">Add None Contract Client </a>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @if($client->client_type == "noneContract")
                                <tr>
