...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> {{ trans('site.home') }}
                </a></li>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td><a href="{{route('invoicePayment' ,$invoice->invoice_id)}}" class="btn btn-warning">{{ trans('site.pay') }}</a></td> -->

                                    <td> <a class="btn btn-warning" href="{{route('invoicePayment' ,$invoice->invoice_id)}}"><i class="fas fa-money" style="margin-right: 10px;"></i>{{ trans('site.pay') }}</a></td>
