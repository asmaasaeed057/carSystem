            ...
            <form action="{{ route('admin.store')}}" method="POST">
              ...
              @method('POST')
                ...
                <div class="form-group">
                  ...
                  <input type="text"name="name" class="form-control" placeholder="{{ trans('site.hintname_admin') }}">
                </div>

                <div class="form-group">
                  <label>{{ trans('site.email_admin') }}</label>
                  <input type="email" name="email" class="form-control" placeholder="{{ trans('site.hintEmail_admin') }}" >
                </div>

                <!-- textarea -->
                <div class="form-group">
                  <label>{{ trans('site.password_admin') }}</label>
                  <input type="password" name="password" class="form-control" placeholder="{{ trans('site.hintpassword_admin') }}" >
                </div>
