...
--
-- Host: localhost
-- Generation Time: Apr 03, 2020 at 11:27 PM
...
(1, 'Ashraf', 'admin@gmail.com', '$2y$10$m7Vffeh7iIbKPPVeFsEtHuIjk6xubZAqb4KZurT642NCoEcM7MpYu', NULL, NULL, '2020-04-03 17:01:13', 1);
...
(8, 2012, 'MKI154', '13543', 'blue', 1, 24, 1, '2020-04-02 18:19:01', '2020-04-02 18:19:01'),
(9, 2022, 'PPP5884', '54+6', 'yellow', 2, 23, 2, '2020-04-02 18:19:57', '2020-04-02 18:20:40');
...
(15, 'beand1', 'beand1', NULL, NULL),
(16, 'beand2', 'beand2', NULL, NULL);
...
(23, 'category 2', 'category 2', 15, '2020-04-02 18:16:59', '2020-04-02 18:16:59'),
(24, 'category 3', 'category 3', 16, '2020-04-02 18:17:15', '2020-04-02 18:17:15');
...
(5, 'service 2', '1516345', 1, '2000', '1000', '5'),
(7, 'service 2', '1516345', 4, '500', '1000', '3');
...
(1, 'ali', 1117589566, 'hghgh', 'a@a.com', 'contract', '2020-01-21 18:52:52', '2020-04-02 19:03:50'),
(2, 'رواسي', 65656, 'ساليالس', 'aaaa@aa.com', 'contract', '2020-01-27 14:07:56', '2020-01-27 14:07:56'),
(3, 'asmaa', 22151554, 'alex egypt', 'asmaa@gmail.com', 'contract', '2020-03-31 15:29:18', '2020-03-31 15:29:18'),
(4, 'amira', 2147483647, 'لوران', 'admin@gmail.com', 'contract', '2020-03-31 16:46:54', '2020-03-31 16:46:54');
...
CREATE TABLE `repair_cards_status` (
  ...
  `card_status` enum('panding','accepted','finished','underMaintance') NOT NULL DEFAULT 'panding',
...
(1, 1, 'accepted', 'as', 1, '2020-01-21 18:54:22', '2020-03-02 19:11:24'),
(2, 1, 'accepted', 'ghghghghg', 1, '2020-01-22 14:25:49', '2020-01-27 17:46:55'),
(8, 1, 'accepted', 'hghg', 1, NULL, '2020-01-27 18:12:57'),
(9, 2, 'underMaintance', 'hggjhgjhg', 1, '2020-01-28 09:37:17', '2020-01-28 09:37:55'),
(11, 1, 'panding', 'HGHGHHGHG', 1, '2020-01-28 18:24:10', '2020-01-28 18:24:10'),
(13, 2, 'panding', 'ghghsgd', 2, '2020-01-28 18:51:16', '2020-01-28 18:51:16');
...
--
ALTER TABLE `car_services`
  MODIFY `service_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `repair_cards_items`
  MODIFY `card_item_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `repair_cards_status`
--
ALTER TABLE `repair_cards_status`
  MODIFY `card_status_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `roles`
  MODIFY `role_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
